...
const AboutPage: React.FC = () => {
  const desk1Data: DeskProps = {
    ...
    text1:
      "I was born in 16th September 1942 in Manglore, studied in mumbai, Qualified as B.Sc. DHMS from Mumbai University, Worked in Glaxo as production officer for 25 Years. Practiced Homeopathy for last 45 years & above, have an experience of Running Medical Education Institutes in mumbai, for past 4 decade work in medical education & renowned charitable trust, established Nursing Assistant Institute, sewing classes and also managed Dialysis centre for 20 years in Mumbai. Strive for women's Employment & Participation in the society through medical field and education treating patient numbering more than 40,000 with high recovery rate.",
    text2: [
  ...
  return (
    <div className="text-black min-h-[60vh] scroll-mt-[80px] mt-30">
      ...
      {/* <section id="#chairmen"> */}
      <div className="px-10 borde mb-8">
        <Desk {...desk1Data} />
      </div>
      {/* </section> */}
