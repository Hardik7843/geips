...
//         <div className="w-full md:w-fit relative aspect-video rounded-2xl borde-2">
//           <img
//             src={students1}
//             alt="person"
...
//         <div className="w-full md:w-[3/5] borde break-words text-justify">
...
const HomePage2 = () => {
  ...
  return (
    <div className="text-black min-h-[60vh] scroll-mt-[80px] mt-30">
      ...
      {/* <div className="px-10 mt-10 border">
